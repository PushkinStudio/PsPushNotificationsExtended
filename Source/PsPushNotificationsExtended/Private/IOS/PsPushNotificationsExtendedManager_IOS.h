...
#include "PsPushNotificationsExtendedManager_IOS.generated.h"

UCLASS()
class UPsPushNotificationsExtendedManagerIOS : public UPsPushNotificationsExtendedManager
{
	GENERATED_UCLASS_BODY()

public:
	/** Disconect signals */
	~UPsPushNotificationsExtendedManagerIOS() override;
...
private:
	/** application has entered foreground callback */
